...
function drawScoreboard() {
	...
	if (gameState === 0) {
		...
		renderText(trueCanvas.width / 2 + gdx + 6 * settings.scale, trueCanvas.height / 2 + gdy - 155 * settings.scale, 75, "#2c3e50", "Hexotris");
...
function showText(text) {
	var messages = {
		...
		'pausedAndroid': "<div class='centeredHeader unselectable'>Game Paused</div><div class='unselectable centeredSubHeader' style='position:absolute;margin-left:-150px;left:50%;margin-top:20px;width:300px;font-size:16px;'><a href = 'https://play.google.com/store/apps/details?id=de.renegust.hexotrispro2' target='_blank'>Want to support the developers? Don't like ads? Tap for Hexotris Pro ad-free!</a></div>",
		'pausediOS': "<div class='centeredHeader unselectable'>Game Paused</div><div class='unselectable centeredSubHeader' style='position:absolute;margin-left:-150px;left:50%;margin-top:20px;width:300px;font-size:16px;'><a href = 'https://www.facebook.com/Hexotris-1478195732487855/' target='_blank'>Want to support the developers? Don't like ads? Tap for Hexotris ad-free!</a></div>",
		'pausedOther': "<div class='centeredHeader unselectable'>Game Paused</div><div class='unselectable centeredSubHeader' style='margin-top:10px;position:absolute;left:50%;margin-left:-190px;max-width:380px;font-size:18px;'><a href = 'https://www.facebook.com/Hexotris-1478195732487855/' target='_blank'>Want to support the developers? Click here to buy one of the ad-free mobile versions!</a></div>",
...
function gameOverDisplay() {
    fireBaseLogEvent("game_over", "page_view", "home");
	window.AppRateManager.gameOver();
    window.AdMobBanner.gameOver();
...
function updateHighScores (){
	...
	if (score > 0 && (highScoreBeat == 'day' || highScoreBeat == 'all_time')) {
		$('#highScoreNameFormContainer').show();
    }
}
